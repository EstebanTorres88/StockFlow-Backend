...
public class MovementController {
    ...
    @GetMapping
    public ResponseEntity<List<MovementResponseModel>> getAll() {
        List<MovementDTO> movementDtos = movementFacade.getAll();
        return ResponseEntity.ok(movementMapper.toMovementResponseModelList(movementDtos));
    }
